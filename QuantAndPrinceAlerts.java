...
public class QuantAndPrinceAlerts {
    public static final String PURCHASE_TOPIC_NAME = "purchase_with_joined_product-dsl";
    public static final String RESULT_TOPIC = "product_quantity_and_price_alerts-dsl";
    ...
    public static Topology buildTopology(SchemaRegistryClient client, Map<String, String> serDeConfig) {
        ...
        purchasesStream.groupBy((key, val) -> val.get("product_id").toString(), Grouped.with(new Serdes.StringSerde(), avroSerde))
                .windowedBy(
                ...
                .aggregate(
                        () -> 0D,
                        (key, val, agg) -> agg += (Double) val.get("owned_money") ,
